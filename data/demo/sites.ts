...
export const demoSites: HeritageSite[] = [
  {
    ...
    sourceNote: 'UNESCO World Heritage inscription, 1997; LDT excavation records.',
    condition: 'watch',
  ...
  },
  {
    ...
    elevation: 105,
    sourceTier: 'archaeological',
    sourceNote: 'Führer survey, 1896; inscription reading after Hultzsch.',
    condition: 'stable',
  ...
  },
  {
    ...
    sourceNote: 'Lumbini Development Trust conservation reports.',
    condition: 'open',
