...
export const demoHistoricalImages: HistoricalImage[] = [
  ...
  {
    id: 'patan-durbar-square.artistic-impression',
    siteId: 'patan-durbar-square',
    vantageId: 'patan-durbar-square.v1',
    date: 'Interpretive',
    caption: plateMeta['patan-durbar-square.artistic-impression'].caption,
    image: plateImages['patan-durbar-square.artistic-impression'],
    evidenceTier: plateMeta['patan-durbar-square.artistic-impression'].evidenceTier,
    attribution: plateMeta['patan-durbar-square.artistic-impression'].attribution,
    sourceId: 'unesco-kv-1979',
    viewpointConfirmed: false,
  },
  {
    id: 'changu-narayan.artistic-impression',
    siteId: 'changu-narayan',
    vantageId: 'changu-narayan.v1',
    date: 'Interpretive',
    caption: plateMeta['changu-narayan.artistic-impression'].caption,
    image: plateImages['changu-narayan.artistic-impression'],
    evidenceTier: plateMeta['changu-narayan.artistic-impression'].evidenceTier,
    attribution: plateMeta['changu-narayan.artistic-impression'].attribution,
    sourceId: 'kvpt-changu',
    viewpointConfirmed: false,
  },
  {
    id: 'manga-hiti.artistic-impression',
    siteId: 'manga-hiti',
    vantageId: 'manga-hiti.v1',
    date: 'Interpretive',
    caption: plateMeta['manga-hiti.artistic-impression'].caption,
    image: plateImages['manga-hiti.artistic-impression'],
    evidenceTier: plateMeta['manga-hiti.artistic-impression'].evidenceTier,
    attribution: plateMeta['manga-hiti.artistic-impression'].attribution,
    sourceId: 'slusser-1982',
    viewpointConfirmed: false,
  },
];
