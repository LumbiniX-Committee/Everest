  ...
  return (
    <Screen scroll>
      ...
      {needsLocation ? (
        <View style={styles.notice}>
          <Text variant="body" tone="secondary">
            Alignment needs to know where you are standing. Without it, use the bearing below and a
            compass.
          </Text>
      ...
      <View style={styles.actions}>
        <Button
          label={locked ? 'Witness' : 'Align to witness'}
          block
          disabled={!locked}
          onPress={() =>
          ...
          accessibilityHint={
            locked
              ? 'Opens the camera to record an observation'
              : 'Available once the device matches the viewpoint'
          }
        />
        {!locked ? (
          <Text variant="caption" tone="muted" center>
            Capture opens when position, bearing and tilt are all within tolerance.
          </Text>
        ) : null}
      </View>
    </Screen>
